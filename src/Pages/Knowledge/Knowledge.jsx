...
import arles from './../../Components/Categories/img/8259a6ab531656700b2650ef57c577f3df8a37b5.jpg'
import { knowledge } from '../../Components/Data/KindsOfBooks/KindofBooks'
  ...
  return (
    ...
    <div className='translation__body container'>
     <div className='translation__wrapper'>
      ...
      <img alt="knowledge1" className='translation__wrapper__img' src={arles}></img>
      <h2 className='translation__wrapper__title'>Knowledge</h2>
      </div>
     ...
     <div className='translation__books__container'>
    {
      knowledge.map((e)=>{
        ...
        <div className='card' key={e.id}>
              <div className='translation__card__container'> <img alt="knowledge2" className='translation__card__img' src={e.img}></img></div>
